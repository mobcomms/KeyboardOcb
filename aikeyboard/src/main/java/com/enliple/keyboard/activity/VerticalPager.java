...
public class VerticalPager extends ViewGroup {
	...
	private static int mFocusedCurrentPageCount = 0;

	private float mFirstStart = 0;
	private float mFirstEnd = 0;
	...
	protected void dispatchDraw(Canvas canvas) {
		...
		// 현재 focused ad image의 position을 setting 한다.
 		setFocusedCurrentPageCount(getCurrentPage());
	...
	public static int getFocusedCurrentPageCount()
	{
		return mFocusedCurrentPageCount;
	}
	
	public static void setFocusedCurrentPageCount(int focusedCurrentPageCount)
	{
		mFocusedCurrentPageCount = focusedCurrentPageCount;
	}
