...
public class NaraKeyboard extends Keyboard {

    private Key mEnterKey;

    public NaraKeyboard(Context context, int xmlLayoutResId) {
        super(context, xmlLayoutResId);
    }

    public NaraKeyboard(Context context, int layoutTemplateResId,
