...
public class OuterWebViewActivity extends AppCompatActivity {
    ...
    private void initViews() {
        ...
        webView.addJavascriptInterface(new OuterWebViewActivity.MyJavaScriptInterface(), "knowhow");

        com.enliple.keyboard.common.Common.SetInset(root);

        offerwallWebViewClient = new OfferwallWebViewClient(OuterWebViewActivity.this, progressBar);
            ...
            webView.setWebViewClient(new WebViewClient() {
                ...
                public boolean shouldOverrideUrlLoading(WebView view, String url) {
                    ...
                    if (url.startsWith("http://") || url.startsWith("https://")){
                        ...
                        try {
                            boolean flag = OfferwallUtils.callApp(OuterWebViewActivity.this, url);
                            if (!flag) {
                ...
                public void onReceivedSslError(WebView view, SslErrorHandler handler, SslError error) {
                    try {
                        AlertDialog.Builder builder = new AlertDialog.Builder(OuterWebViewActivity.this);
                        builder.setTitle("")
    ...
    private void offerwallParticipation(OfferwallParticipationReq req, boolean isRetry) {
        CustomAsyncTask task = new CustomAsyncTask(OuterWebViewActivity.this);
                    ...
                    try {
                        ...
                        if ( object != null ) {
                            ...
                            if ( rt == 0 ) {
                                ...
                                Toast.makeText(OuterWebViewActivity.this, i_point + "P를 적립하였습니다.", Toast.LENGTH_SHORT).show();
                                Intent intent = new Intent(KeyboardOfferwallListActivity.OFFERWALL_JOIN);
                                sendBroadcast(intent);
                            } else {
                                if (Common.IsFormissionTokenError(OuterWebViewActivity.this, rt) ) {
                                    if ( !isRetry ) {
                                        CustomAsyncTask inTask = new CustomAsyncTask(OuterWebViewActivity.this);
                                                    ...
                                                    try {
                                                        ...
                                                        if ( object != null ) {
                                                            ...
                                                            if ( rt == 0 ) {
                                                                ...
                                                                SharedPreference.setString(OuterWebViewActivity.this, Key.KEY_FORMISSION_TOKEN, tk);
                                                                offerwallParticipation(req, true);
                                                            } else {
                                                                // 토큰 획득 실패 후처리
                                                                Toast.makeText(OuterWebViewActivity.this, getString(R.string.aikbd_offerwall_fail_toast_message), Toast.LENGTH_SHORT).show();
                                                            }
                                                        }
                                                    } catch (Exception e) {
                                                        e.printStackTrace();
                                    ...
                                    if ( !TextUtils.isEmpty(msg) ) {
                                        Toast.makeText(OuterWebViewActivity.this, msg, Toast.LENGTH_SHORT).show();
                                    }
                                }
                            }
                        }
