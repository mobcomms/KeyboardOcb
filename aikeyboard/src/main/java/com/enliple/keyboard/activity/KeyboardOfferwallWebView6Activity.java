...
public class KeyboardOfferwallWebView6Activity extends AppCompatActivity {
    ...
    private void initViews() {
        ...
        webView.addJavascriptInterface(new KeyboardOfferwallWebView6Activity.MyJavaScriptInterface(), "knowhow");

        offerwallWebViewClient = new OfferwallWebViewClient(KeyboardOfferwallWebView6Activity.this, progressBar);
        ...
        btn_get_reward.setOnClickListener(new OnKeyboardSingleClickListener() {
            ...
            protected void onSingleClick(View v) {
                ...
                String mediaUserKey = SharedPreference.getString(KeyboardOfferwallWebView6Activity.this, Key.KEY_OCB_USER_ID);
                try {
                    E_Cipher cp = E_Cipher.getInstance();
                    mediaUserKey = cp.Decode(KeyboardOfferwallWebView6Activity.this, mediaUserKey);
                } catch (Exception e) {
                    e.printStackTrace();
                }
            ...
            offerwallWebChromeClient.setCallback(new OfferwallWebChromeClient.WebChromeClientCallback() {
                ...
                public void onChromePageFinished(WebView webView, String url) {
                    ...
                    if ( !buttonEnabled ) {
                        ...
                        if ( !path.contains("pomission.com")) {
                            completeMission();
                        }
                    }
                }
                ...
                public void isGuideVisible(String isVisible) {
                    LogPrint.d("isGuideVisible isVisible 2 :: " + isVisible);
                }
            ...
            webView.setWebViewClient(new WebViewClient() {
                ...
                public boolean shouldOverrideUrlLoading(WebView view, String url) {
                    ...
                    if (url.startsWith("http://") || url.startsWith("https://")){
                        ...
                        try {
                            boolean flag = OfferwallUtils.callApp(KeyboardOfferwallWebView6Activity.this, url);
                            if (!flag) {
                ...
                public void onReceivedSslError(WebView view, SslErrorHandler handler, SslError error) {
                    try {
                        AlertDialog.Builder builder = new AlertDialog.Builder(KeyboardOfferwallWebView6Activity.this);
                        builder.setTitle("")
    ...
    private void offerwallParticipation(OfferwallParticipationReq req, boolean isRetry) {
        CustomAsyncTask task = new CustomAsyncTask(KeyboardOfferwallWebView6Activity.this);
                    ...
                    try {
                        ...
                        if ( object != null ) {
                            ...
                            if ( rt == 0 ) {
                                ...
                                Toast.makeText(KeyboardOfferwallWebView6Activity.this, i_point + "P를 적립하였습니다.", Toast.LENGTH_SHORT).show();
                                Intent intent = new Intent(KeyboardOfferwallListActivity.OFFERWALL_JOIN);
                                sendBroadcast(intent);
                            } else {
                                if (Common.IsFormissionTokenError(KeyboardOfferwallWebView6Activity.this, rt) ) {
                                    if ( !isRetry ) {
                                        CustomAsyncTask inTask = new CustomAsyncTask(KeyboardOfferwallWebView6Activity.this);
                                                    ...
                                                    try {
                                                        ...
                                                        if ( object != null ) {
                                                            ...
                                                            if ( rt == 0 ) {
                                                                ...
                                                                SharedPreference.setString(KeyboardOfferwallWebView6Activity.this, Key.KEY_FORMISSION_TOKEN, tk);
                                                                offerwallParticipation(req, true);
                                                            } else {
                                                                // 토큰 획득 실패 후처리
                                                                Toast.makeText(KeyboardOfferwallWebView6Activity.this, getString(R.string.aikbd_offerwall_fail_toast_message), Toast.LENGTH_SHORT).show();
                                                            }
                                                        }
                                                    } catch (Exception e) {
                                                        e.printStackTrace();
                                    ...
                                    if ( !TextUtils.isEmpty(msg) ) {
                                        Toast.makeText(KeyboardOfferwallWebView6Activity.this, msg, Toast.LENGTH_SHORT).show();
                                    }
                                }
                            }
                        }
    ...
    public class MyJavaScriptInterface {
        ...
        public void sendNaverId(String id) {
            LogPrint.d("n_Id : " + id);
            SharedPreference.setString(KeyboardOfferwallWebView6Activity.this, Key.KEY_N_ID, id);
        }
    }
}
