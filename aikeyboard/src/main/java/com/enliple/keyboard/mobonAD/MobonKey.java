...
public class MobonKey {
    ...
    // Modified by 김현준 (2015-02-10) : 모비온 광고주 리스트 상수값 변경! (고유 Prefix 추가! MOBON_)
    ...
    // META_DATA_MEDIA_CODE 에 따른 u,su,s,bntype 의 키 값
    ...
    protected static final String MOBON_MEDIA_ENDING_S_VALUE = "Key.MOBON_MEDIA_ENDING_S_VALUE";
    protected static final String MOBON_MEDIA_INTRO_S_VALUE = "Key.MOBON_MEDIA_INTRO_S_VALUE";
    protected static final String MOBON_MEDIA_BANNER_S_VALUE = "Key.MOBON_MEDIA_BANNER_S_VALUE";
    protected static final String MOBON_MEDIA_BACON_S_VALUE = "Key.MOBON_MEDIA_BACON_S_VALUE";
    protected static final String MOBON_MEDIA_JSONDATA_S_VALUE = "Key.MOBON_MEDIA_JSONDATA_S_VALUE";
    protected static final String MOBON_MEDIA_JSONDATA_S2_VALUE = "Key.MOBON_MEDIA_JSONDATA_S2_VALUE";
    protected static final String MOBON_MEDIA_JSONDATA_S3_VALUE = "Key.MOBON_MEDIA_JSONDATA_S3_VALUE";
    protected static final String MOBON_MEDIA_JSONDATA_S4_VALUE = "Key.MOBON_MEDIA_JSONDATA_S4_VALUE";
    protected static final String MOBON_MEDIA_MCOVER_S_VALUE = "Key.MOBON_MEDIA_MCOVER_S_VALUE";
    protected static final String MOBON_MEDIA_MCOVER_S2_VALUE = "Key.MOBON_MEDIA_MCOVER_S2_VALUE";
    ...
    protected static final String BACON_CHECKABLE_DATE = "Key.BACON_CHECKABLE_DATE";
    public static final String BACON_URL_LIST_DATA = "Key.BACON_URL_LIST_DATA";
    protected static final String BACON_DOWNLAD_CYCLE = "Key.BACON_DOWNLAD_CYCLE";
    protected static final String MCOVER_DISPLAY_SHOWTIME = "Key.MCOVER_DISPLAY_SHOWTIME";


    // ending popup 종류의 저장 키값
    ...
    public enum ENDING_TYPE {NORMAL, FULL, SHORTCUT}

    public enum INTERSTITIAL_TYPE {NORMAL, FULL, SMALL, MEDIATION_NORMAL,SHORTCUT, MEDIATION_ADFIT_SMALL}


    //banner init BroadCast
    ...
    protected static final String NATIVE_CACHE_DATA = "Key.NATIVE_CACHE_DATA";
    protected static final String NATIVE_CACHE_GUBUN = "Key.NATIVE_CACHE_GUBUN";
    protected static final String NATIVE_CACHE_TIME = "Key.NATIVE_CACHE_TIME";
    ...
    public enum ENDING_KEYCODE {CANCEL,BACKKEY_CLOSE, CLOSE, ADCLICK}

    public enum INTERSTITIAL_KEYCODE {CLOSE, ADCLICK}
    ...
    public static final String CURRENT_BROWSER_PAKAGENAME = "Key.CURRENT_BROWSER_PAKAGENAME";
    public static final String DEFAULT_BROWSER_RUN = "Key.DEFAULT_BROWSER_RUN";
    ...
    // Mediation
    public static final String MEDIATION_INFO_DATA = "Key.MEDIATION_INFO_DATA";
    public static final String INFO_CHECK_DATE = "Key.INFO_CHECK_DATE";
