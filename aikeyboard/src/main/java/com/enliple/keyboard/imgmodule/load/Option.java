 ...
 * com.enliple.keyboard.imgmodule.load.engine.DiskCacheStrategy#RESOURCE}.
 *
...
public final class Option<T> {
   ...
   * com.enliple.keyboard.imgmodule.load.Option.CacheKeyUpdater} to update disk cache keys.
   *
   * @param key A unique package prefixed {@link String} that identifies this option (must be stable
   *     across builds, so {@link Class#getName()} should <em>not</em> be used).
   */
  ...
  /**
   * Returns a new {@link Option} that uses the given {@link
   * com.enliple.keyboard.imgmodule.load.Option.CacheKeyUpdater} to update disk cache keys and provides the
   ...
   * using the {@link com.enliple.keyboard.imgmodule.load.Option.CacheKeyUpdater} optionally provided in the
   * constructor.
   */
