package com.enliple.keyboard.imgmodule.load.data.mediastore;
...
import com.enliple.keyboard.imgmodule.load.data.ExifOrientationStream;
...
public class ThumbFetcher implements DataFetcher<InputStream> {
  ...
  private static ThumbFetcher build(Context context, Uri uri, ThumbnailQuery query) {
    ArrayPool byteArrayPool = ImageModule.get(context).getArrayPool();
