 ...
 *     com.enliple.keyboard.imgmodule.load.ResourceDecoder} to decode a resource.
 */
public interface ModelLoader<Model, Data> {

  /**
   * Contains a set of {@link com.enliple.keyboard.imgmodule.load.Key Keys} identifying the source of the load,
   * alternate cache keys pointing to equivalent data, and a {@link
   * com.enliple.keyboard.imgmodule.load.data.DataFetcher} that can be used to fetch data not found in cache.
   *
  ...
  /**
   * Returns a {@link com.enliple.keyboard.imgmodule.load.model.ModelLoader.LoadData} containing a {@link
   * com.enliple.keyboard.imgmodule.load.data.DataFetcher} required to decode the resource represented by this
   * model, as well as a set of {@link com.enliple.keyboard.imgmodule.load.Key Keys} that identify the data
   * loaded by the {@link com.enliple.keyboard.imgmodule.load.data.DataFetcher} as well as an optional list of
   ...
   *     {@link com.enliple.keyboard.imgmodule.request.target.Target#SIZE_ORIGINAL} to indicate that the
