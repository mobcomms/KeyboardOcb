...
import com.enliple.keyboard.imgmodule.ImageBuilder.WaitForFramesAfterTrimMemory;
import com.enliple.keyboard.imgmodule.ImageExperiments;
...
public class RequestManagerRetriever implements Handler.Callback {
  @VisibleForTesting static final String FRAGMENT_TAG = "com.enliple.keyboard.imgmodule.manager";
  ...
  public RequestManagerRetriever(
      @Nullable RequestManagerFactory factory, ImageExperiments experiments) {
  ...
  private static FrameWaiter buildFrameWaiter(ImageExperiments experiments) {
    ...
    if (applicationManager == null) {
      synchronized (this) {
        if (applicationManager == null) {
          ...
          ImageModule imageModule = ImageModule.get(context.getApplicationContext());
          applicationManager =
              factory.build(
                  imageModule,
  ...
  private RequestManager fragmentGet(
    ...
    if (requestManager == null) {
      ...
      ImageModule imageModule = ImageModule.get(context);
      requestManager =
          factory.build(
              imageModule, current.getImageLifecycle(), current.getRequestManagerTreeNode(), context);
