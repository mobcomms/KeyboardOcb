...
import com.enliple.keyboard.imgmodule.request.transition.NoTransition;
import com.enliple.keyboard.imgmodule.request.transition.TransitionFactory;
import com.enliple.keyboard.imgmodule.request.transition.ViewAnimationFactory;
import com.enliple.keyboard.imgmodule.request.transition.ViewPropertyAnimationFactory;
import com.enliple.keyboard.imgmodule.request.transition.ViewPropertyTransition;
...
public abstract class TransitionOptions<
   ...
   *
   * @param animator The {@link com.enliple.keyboard.imgmodule.request.transition.ViewPropertyTransition
   *     .Animator} to run.
   * @return This request builder.
   */
  @NonNull
   ...
   * com.enliple.keyboard.imgmodule.request.transition.Transition} for each request started with these {@code
   * TransitionOptions}.
   *
   * @return This request builder.
   */
