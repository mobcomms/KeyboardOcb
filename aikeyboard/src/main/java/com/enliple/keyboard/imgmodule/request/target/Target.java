...
/**
 * An interface that ImageModule can load a resource into and notify of relevant lifecycle events during a
 * load.
 *
...
public interface Target<R> extends LifecycleListener {
  ...
  /** Sets the current request for this target to retain, should not be called outside of ImageModule. */
  void setRequest(@Nullable Request request);

  /** Retrieves the current request for this target, should not be called outside of ImageModule. */
  @Nullable
  Request getRequest();
}
