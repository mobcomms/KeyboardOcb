package com.enliple.keyboard.imgmodule.load.data;
 ...
 * com.enliple.keyboard.imgmodule.load.model.ModelLoader}. {@link #loadData(Priority,
 * com.enliple.keyboard.imgmodule.load.data.DataFetcher.DataCallback)} may or may not be called for any given
 ...
 * com.enliple.keyboard.imgmodule.load.data.DataFetcher.DataCallback)}} is called, then so {@link #cleanup()}
 * will be called.
 *
...
public interface DataFetcher<T> {
   ...
   * com.enliple.keyboard.imgmodule.load.data.DataFetcher.DataCallback)} has been decoded by the {@link
   * com.enliple.keyboard.imgmodule.load.ResourceDecoder}.
   *
   * <p>Note - this method will be run on a background thread so blocking I/O is safe.
   */
  void cleanup();
  ...
  /** Returns the {@link com.enliple.keyboard.imgmodule.load.DataSource} this fetcher will return data from. */
  @NonNull
