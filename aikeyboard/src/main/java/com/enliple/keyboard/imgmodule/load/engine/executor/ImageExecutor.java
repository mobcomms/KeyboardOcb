package com.enliple.keyboard.imgmodule.load.engine.executor;
...
/** A prioritized {@link ThreadPoolExecutor} for running jobs in ImageModule. */
public final class ImageExecutor implements ExecutorService {
  /**
  ...
  /**
   * The default thread count for executors used to load/decode/transform data found in ImageModule
   * cache.
   */
  private static final int DEFAULT_DISK_CACHE_EXECUTOR_THREADS = 1;

  private static final String TAG = "ImageModuleExecutor";
   ...
   */
  public static ImageExecutor.Builder newDiskCacheBuilder() {
    return new ImageExecutor.Builder(/*preventNetworkOperations=*/ true)
  ...
  public static ImageExecutor newDiskCacheExecutor() {
   ...
   * the {@link
   * ImageExecutor.UncaughtThrowableStrategy#DEFAULT}
   * uncaught throwable strategy.
   *
   * <p>Source executors allow network operations on their threads.
   */
  public static ImageExecutor.Builder newSourceBuilder() {
    return new ImageExecutor.Builder(/*preventNetworkOperations=*/ false)
  ...
  public static ImageExecutor newSourceExecutor() {
   ...
   * <p>Source executors allow network operations on their threads.
   */
  public static ImageExecutor newUnlimitedSourceExecutor() {
   ...
   */
  public static ImageExecutor.Builder newAnimationBuilder() {
  ...
  public static ImageExecutor newAnimationExecutor() {
  ...
  @VisibleForTesting
  ImageExecutor(ExecutorService delegate) {
  ...
  private static final class DefaultThreadFactory implements ThreadFactory {
    ...
    public synchronized Thread newThread(@NonNull Runnable runnable) {
      final Thread result =
          new Thread(runnable, "ImageModule-" + name + "-thread-" + threadNum) {
            @Override
            public void run() {
  ...
  /** A builder for {@link ImageExecutor}s. */
  public static final class Builder {
     ...
     * on {@link ImageExecutor}s built by this {@code Builder}.
     */
    ...
    /**
     * Sets the prefix to use for each thread name created by any {@link ImageExecutor}s built by
     * this {@code Builder}.
     */
    ...
    /** Builds a new {@link ImageExecutor} with any previously specified options. */
    public ImageExecutor build() {
      ...
      return new ImageExecutor(executor);
    }
  }
}
