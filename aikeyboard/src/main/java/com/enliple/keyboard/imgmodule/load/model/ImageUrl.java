 ...
 *
 * <p>Users wishing to replace the class for handling URLs must register a factory using ImageModuleUrl.
 *
 ...
 *
 * <p>This class can also optionally wrap {@link com.enliple.keyboard.imgmodule.load.model.Headers} for
 * convenience.
 */
public class ImageUrl implements Key {
  ...
  public ImageUrl(String url, Headers headers) {
    this.url = null;
