...
public abstract class DiskCacheStrategy {
   ...
   * com.enliple.keyboard.imgmodule.load.data.DataFetcher} and the {@link
   * com.enliple.keyboard.imgmodule.load.EncodeStrategy} of the {@link com.enliple.keyboard.imgmodule.load.ResourceEncoder}
   * (if an {@link com.enliple.keyboard.imgmodule.load.ResourceEncoder} is available).
   */
   ...
   *     com.enliple.keyboard.imgmodule.load.ResourceEncoder} will use to encode the resource.
   */
