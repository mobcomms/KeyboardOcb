...
/** A request that loads a resource for an {@link com.enliple.keyboard.imgmodule.request.target.Target}. */
public interface Request {
   ...
   * com.enliple.keyboard.imgmodule.request.target.Target}s (for example). Using a similar but different method
