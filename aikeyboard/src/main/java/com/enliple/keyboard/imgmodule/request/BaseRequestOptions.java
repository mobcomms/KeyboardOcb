...
import com.enliple.keyboard.imgmodule.RequestBuilder;
import com.enliple.keyboard.imgmodule.TransitionOptions;
...
import com.enliple.keyboard.imgmodule.load.resource.bitmap.CenterInside;
import com.enliple.keyboard.imgmodule.load.resource.bitmap.CircleCrop;
import com.enliple.keyboard.imgmodule.load.resource.bitmap.DownsampleStrategy;
import com.enliple.keyboard.imgmodule.load.resource.bitmap.Downsampler;
import com.enliple.keyboard.imgmodule.load.resource.bitmap.DrawableTransformation;
import com.enliple.keyboard.imgmodule.load.resource.bitmap.FitCenter;
...
import com.enliple.keyboard.imgmodule.load.resource.gif.GifDrawableTransformation;
import com.enliple.keyboard.imgmodule.load.resource.gif.GifOptions;
import com.enliple.keyboard.imgmodule.signature.EmptySignature;
import com.enliple.keyboard.imgmodule.util.CachedHashCodeArrayMap;
...
public abstract class BaseRequestOptions<T extends BaseRequestOptions<T>> implements Cloneable {
  ...
  /**
   * Applies a multiplier to the {@link com.enliple.keyboard.imgmodule.request.target.Target}'s size before
   ...
   *     com.enliple.keyboard.imgmodule.request.target.Target}'s dimensions when loading the resource.
   ...
   * the request.
   *
   * <p>This method should <em>ONLY</em> be used when a ImageModule load is started recursively on one of
   * ImageModule threads as part of another request. Using this method in other scenarios can lead to
   ...
   * load remote data. The animation executor has fewer threads available to it than ImageModule normal
   ...
   * resource id model on ImageModule background threads. The theme is used exclusively on the main
  ...
  /**
   * Overrides the {@link com.enliple.keyboard.imgmodule.request.target.Target}'s width and height with the
   ...
   * @return This request builder.
   * @see com.enliple.keyboard.imgmodule.signature.ObjectKey
   */
  @NonNull
  @CheckResult
   ...
   * com.enliple.keyboard.imgmodule.load.resource.bitmap.BitmapEncoder#COMPRESSION_FORMAT}.
   */
  @NonNull
  @CheckResult
   ...
   * Downsampler} and ImageModule default GIF decoders.
   *
   ...
   * has alpha).
   *
   * <p>This is a component option specific to {@link Downsampler} and ImageModule GIF decoders. If the
   ...
   * Downsampler#ALLOW_HARDWARE_CONFIG}, ImageModule will set the value per request based on whether or
   ...
   * com.enliple.keyboard.imgmodule.load.resource.bitmap.DownsampleStrategy.CenterOutside} can safely use {@link
   ...
   *
   * <p>This is a component option specific to ImageModule default networking library and {@link
   * HttpImageUrlLoader}. If you use any other networking
   * library including ImageModule Volley or OkHttp integration libraries, this option will be ignored.
   *
   * @see HttpImageUrlLoader#TIMEOUT
   * @param timeoutMs The read and write timeout in milliseconds.
   */
  @NonNull
  @CheckResult
  public T timeout(@IntRange(from = 0) int timeoutMs) {
    return set(HttpImageUrlLoader.TIMEOUT, timeoutMs);
  }

  /**
   * Applies {@link com.enliple.keyboard.imgmodule.load.resource.bitmap.CenterCrop} to all default types, and
  ...
  /**
   * Applies {@link com.enliple.keyboard.imgmodule.load.resource.bitmap.CenterInside} to all default types,
   ...
   * com.enliple.keyboard.imgmodule.load.resource.gif.GifDrawable}) and throws an exception if asked to
   ...
   * Applies the given {@link Transformation} for {@link Bitmap Bitmaps} to the default types
   * ({@link Bitmap}, {@link android.graphics.drawable.BitmapDrawable}, and {@link
   * com.enliple.keyboard.imgmodule.load.resource.gif.GifDrawable}) and ignores unknown types.
   *
   * <p>This will override previous calls to {@link #dontTransform()}.
   *
   * @param transformation Any {@link Transformation} for {@link Bitmap}s.
