...
/**
 * A class that allows {@link com.enliple.keyboard.imgmodule.load.resource.transcode.ResourceTranscoder}s to be
...
public class TranscoderRegistry {
  ...
  /**
   * Registers the given {@link com.enliple.keyboard.imgmodule.load.resource.transcode.ResourceTranscoder} using
   ...
   * com.enliple.keyboard.imgmodule.load.resource.transcode.ResourceTranscoder} for the given classes.
   *
