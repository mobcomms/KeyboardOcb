 ...
 * {@link CustomViewTarget}. Using this class to load resources into {@link View}s can prevent ImageModule
 ...
 * manually clear this {@link Target}, ImageModule may do so automatically after certain lifecycle events
...
public abstract class CustomTarget<T> implements Target<T> {
   ...
   * {@link com.enliple.keyboard.imgmodule.request.RequestOptions#override(int)}. In all other cases, prefer
   ...
   * com.enliple.keyboard.imgmodule.request.RequestOptions#override(int)} in the request).
   *
