...
public class UrlUriLoader<Data> implements ModelLoader<Uri, Data> {
  ...
  private final ModelLoader<ImageUrl, Data> urlLoader;

  // Public API.
  @SuppressWarnings("WeakerAccess")
  public UrlUriLoader(ModelLoader<ImageUrl, Data> urlLoader) {
  ...
  public LoadData<Data> buildLoadData(
    ...
    return urlLoader.buildLoadData(imageUrl, width, height, options);
  }
  ...
  public static class StreamFactory implements ModelLoaderFactory<Uri, InputStream> {
    ...
    public ModelLoader<Uri, InputStream> build(MultiModelLoaderFactory multiFactory) {
      return new UrlUriLoader<>(multiFactory.build(ImageUrl.class, InputStream.class));
    }
