 ...
 * differ depending on the {@link com.enliple.keyboard.imgmodule.load.ResourceDecoder} using the strategy and
 ...
 * com.enliple.keyboard.imgmodule.load.Transformation} either instead or in addition to a {@code
 * DownsampleStrategy}.
 *
 * <p>Some differences between versions of Android and {@link
 * com.enliple.keyboard.imgmodule.load.ResourceDecoder}s are listed below, but the list is not comprehensive
 ...
 * is supported. To preserve the potential for a {@link com.enliple.keyboard.imgmodule.load.Transformation} to
...
public abstract class DownsampleStrategy {
  ...
  public static final Option<DownsampleStrategy> OPTION =
      Option.memory(
          "com.enliple.keyboard.imgmodule.load.resource.bitmap.Downsampler.DownsampleStrategy", DEFAULT);
