...
/**
 * A ImageModule {@link BitmapTransformation} to circle crop an image. Behaves similar to a {@link
...
public class CircleCrop extends BitmapTransformation {
  ...
  private static final String ID = "com.enliple.keyboard.imgmodule.load.resource.bitmap.CircleCrop." + VERSION;
