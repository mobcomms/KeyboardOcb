...
import com.enliple.keyboard.imgmodule.load.HttpException;
import com.enliple.keyboard.imgmodule.load.model.ImageUrl;
import com.enliple.keyboard.imgmodule.util.ContentLengthInputStream;
...
public class HttpUrlFetcher implements DataFetcher<InputStream> {
  ...
  public HttpUrlFetcher(ImageUrl imageUrl, int timeout) {
    this(imageUrl, timeout, DEFAULT_CONNECTION_FACTORY);
  }

  @VisibleForTesting
  HttpUrlFetcher(ImageUrl imageUrl, int timeout, HttpUrlConnectionFactory connectionFactory) {
  ...
  public void loadData(
    ...
    try {
      InputStream result = loadDataWithRedirects(imageUrl.toURL(), 0, null, imageUrl.getHeaders());
