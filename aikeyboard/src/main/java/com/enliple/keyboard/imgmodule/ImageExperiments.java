...
/**
 * Keeps track of a set of Experimental features that may be enabled in ImageModule, simplifying the
...
public class ImageExperiments {
  ...
  @Synthetic
  ImageExperiments(Builder builder) {
    this.experiments =
