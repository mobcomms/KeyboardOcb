...
import static com.enliple.keyboard.imgmodule.request.RequestOptions.diskCacheStrategyOf;
import static com.enliple.keyboard.imgmodule.request.RequestOptions.signatureOf;
import static com.enliple.keyboard.imgmodule.request.RequestOptions.skipMemoryCacheOf;
...
import com.enliple.keyboard.imgmodule.request.ErrorRequestCoordinator;
import com.enliple.keyboard.imgmodule.request.FutureTarget;
import com.enliple.keyboard.imgmodule.request.Request;
import com.enliple.keyboard.imgmodule.request.RequestCoordinator;
import com.enliple.keyboard.imgmodule.request.RequestFutureTarget;
...
import com.enliple.keyboard.imgmodule.request.SingleRequest;
import com.enliple.keyboard.imgmodule.request.ThumbnailRequestCoordinator;
import com.enliple.keyboard.imgmodule.request.target.PreloadTarget;
...
import com.enliple.keyboard.imgmodule.signature.AndroidResourceSignature;
import com.enliple.keyboard.imgmodule.util.Executors;
import com.enliple.keyboard.imgmodule.util.Preconditions;
import com.enliple.keyboard.imgmodule.util.Synthetic;
 ...
 *     com.enliple.keyboard.imgmodule.request.target.Target}.
 */
// Public API.
...
public class RequestBuilder<TranscodeType> extends BaseRequestOptions<RequestBuilder<TranscodeType>>
  ...
  protected RequestBuilder(
      @NonNull ImageModule imageModule,
    ...
    this.imageContext = imageModule.getImageContext();
  ...
  protected RequestBuilder(Class<TranscodeType> transcodeClass, RequestBuilder<?> other) {
    this(other.imageModule, other.requestManager, transcodeClass, other.context);
    model = other.model;
   ...
   * com.enliple.keyboard.imgmodule.load.model.ModelLoader}, {@link com.enliple.keyboard.imgmodule.load.ResourceDecoder},
   * and {@link com.enliple.keyboard.imgmodule.load.Transformation}s. However, {@link
   * com.enliple.keyboard.imgmodule.request.RequestOptions#placeholder(int)} and {@link
   * com.enliple.keyboard.imgmodule.request.RequestOptions#error(int)}, and {@link #listener(RequestListener)}
   ...
   *
   * <p>It's almost always better to allow ImageModule to load {@link Bitmap}s than pass {@link Bitmap}s
   * into ImageModule. If you have a custom way to obtain {@link Bitmap}s that is not supported by ImageModule
   * by default, consider registering a custom {@link com.enliple.keyboard.imgmodule.load.model.ModelLoader} or
   * {@link com.enliple.keyboard.imgmodule.load.ResourceDecoder} instead of using this method.
   *
   ...
   *
   * <p>It's almost always better to allow ImageModule to load {@link Bitmap}s than to pass {@link
   * Bitmap}s into ImageModule using this method . If you have a custom way to obtain {@link Bitmap}s that
   * is not supported by ImageModule by default, consider registering a custom {@link
   * com.enliple.keyboard.imgmodule.load.model.ModelLoader} or {@link com.enliple.keyboard.imgmodule.load.ResourceDecoder}
   ...
   * com.enliple.keyboard.imgmodule.request.RequestOptions#signature(com.enliple.keyboard.imgmodule.load.Key)} to mixin a
   ...
   * com.enliple.keyboard.imgmodule.load.engine.DiskCacheStrategy#NONE} and/or {@link
   * com.enliple.keyboard.imgmodule.request.RequestOptions#skipMemoryCache(boolean)} may be appropriate.
   *
   * @see #load(Object)
   * @param string A file path, or a uri or url handled by {@link
   *     com.enliple.keyboard.imgmodule.load.model.UriLoader}.
   */
  @NonNull
  @Override
  @CheckResult
   ...
   * com.enliple.keyboard.imgmodule.load.model.ModelLoaderFactory} currently registered or {@link Integer} to
   * load the image represented by the given {@link Integer} resource id. Defaults to {@link
   * com.enliple.keyboard.imgmodule.load.model.ResourceLoader} to load resource id models.
   *
   * <p>By default this method adds a version code and night mode based signature to the cache key
   * used to cache this resource in ImageModule. This signature is sufficient to guarantee that end users
   ...
   * consider using {@link com.enliple.keyboard.imgmodule.load.engine.DiskCacheStrategy#NONE} via {@link
   * RequestOptions#diskCacheStrategy(com.enliple.keyboard.imgmodule.load.engine.DiskCacheStrategy)} during
   * development, and re-enabling the default {@link
   * com.enliple.keyboard.imgmodule.load.engine.DiskCacheStrategy#RESOURCE} for release builds.
   *
   * <p>This method will load non-{@link android.graphics.Bitmap} resources like {@link
   * android.graphics.drawable.VectorDrawable}s. Although ImageModule makes a best effort to apply {@link
   * com.enliple.keyboard.imgmodule.load.Transformation}s to these {@link Drawable}s by either extracting the
   * underlying {@link Bitmap} or by converting the {@link Drawable} to a {@link Bitmap}, ImageModule is
   * still not able to transform all types of resources. Animated {@link Drawable}s cannot be
   * transformed (other than {@link com.enliple.keyboard.imgmodule.load.resource.gif.GifDrawable}). To avoid
   ...
   * method, especially in conjunction with {@link com.enliple.keyboard.imgmodule.load.Transformation}s with
   * caution for non-{@link Bitmap} {@link Drawable}s.
   *
   * @see #load(Integer)
   * @see com.enliple.keyboard.imgmodule.signature.AndroidResourceSignature
   */
  @NonNull
  @CheckResult
  @Override
   ...
   * the view, and frees any resources ImageModule may have previously loaded into the view so they may be
   * reused.
   *
   * @see RequestManager#clear(Target)
   * @param view The view to cancel previous loads for and load the new resource into.
   * @return The {@link com.enliple.keyboard.imgmodule.request.target.Target} used to wrap the given {@link
   *     ImageView}.
   */
  @NonNull
  public ViewTarget<ImageView, TranscodeType> into(@NonNull ImageView view) {
    ...
    return into(
        imageContext.buildImageViewTarget(view, transcodeClass),
        /*targetListener=*/ null,
        requestOptions,
   ...
   *     overridden by {@link com.enliple.keyboard.imgmodule.request.RequestOptions#override(int, int)} if
   *     previously called.
