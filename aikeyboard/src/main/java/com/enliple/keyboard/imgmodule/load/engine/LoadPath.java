...
/**
 * For a given {@link com.enliple.keyboard.imgmodule.load.data.DataFetcher} for a given data class, attempts to
 * fetch the data and then run it through one or more {@link
 * com.enliple.keyboard.imgmodule.load.engine.DecodePath}s.
 *
 ...
 *     {@link com.enliple.keyboard.imgmodule.load.engine.DecodePath}s.
...
public class LoadPath<Data, ResourceType, Transcode> {
  ...
  private Resource<Transcode> loadWithExceptionList(
    ...
    if (result == null) {
      throw new ImageModuleException(failureMessage, new ArrayList<>(exceptions));
    }
