...
public interface RequestListener<R> {
   ...
   * ImageModule.with(fragment/activity).load()} to avoid object churn.
   *
   ...
   * Target#onResourceReady(Object, com.enliple.keyboard.imgmodule.request.transition.Transition)}.
   *
   * <p>For threading guarantees, see the class comment.
   *
