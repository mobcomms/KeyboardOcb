...
public interface Transformation<T> extends Key {
   ...
   * com.enliple.keyboard.imgmodule.load.engine.DiskCacheStrategy#NONE} or make sure {@link
   ...
   *     com.enliple.keyboard.imgmodule.request.target.Target#SIZE_ORIGINAL} to indicate the original resource
   *     width.
