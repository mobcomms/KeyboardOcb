...
class EngineJob<R> implements DecodeJob.Callback<R>, Poolable {
  ...
  private final ImageExecutor diskCacheExecutor;
  private final ImageExecutor sourceExecutor;
  private final ImageExecutor sourceUnlimitedExecutor;
  private final ImageExecutor animationExecutor;
  ...
  private ImageExecutor getActiveSourceExecutor() {
