 ...
 * android.graphics.Bitmap}s returned by {@link com.enliple.keyboard.imgmodule.load.ResourceDecoder}s.
 *
 * <p>Note - In some cases it may not be possible to obey the requested setting, not all {@link
 * com.enliple.keyboard.imgmodule.load.resource.bitmap.Downsampler}s support setting formats and certain images
...
public enum DecodeFormat {
  /**
   * Bitmaps returned by the {@link com.enliple.keyboard.imgmodule.load.ResourceDecoder}. should return {@link
   ...
   * use {@link com.enliple.keyboard.imgmodule.request.RequestOptions#disallowHardwareConfig()}.
   *
