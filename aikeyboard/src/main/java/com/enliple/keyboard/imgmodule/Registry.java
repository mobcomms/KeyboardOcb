...
import com.enliple.keyboard.imgmodule.load.data.DataRewinder;
import com.enliple.keyboard.imgmodule.load.data.DataRewinderRegistry;
import com.enliple.keyboard.imgmodule.load.engine.DecodePath;
import com.enliple.keyboard.imgmodule.load.engine.LoadPath;
...
import com.enliple.keyboard.imgmodule.load.model.ModelLoaderRegistry;
import com.enliple.keyboard.imgmodule.load.resource.transcode.ResourceTranscoder;
import com.enliple.keyboard.imgmodule.load.resource.transcode.TranscoderRegistry;
import com.enliple.keyboard.imgmodule.provider.EncoderRegistry;
import com.enliple.keyboard.imgmodule.provider.ImageHeaderParserRegistry;
import com.enliple.keyboard.imgmodule.provider.LoadPathCache;
import com.enliple.keyboard.imgmodule.provider.ModelToResourceClassCache;
import com.enliple.keyboard.imgmodule.provider.ResourceDecoderRegistry;
import com.enliple.keyboard.imgmodule.provider.ResourceEncoderRegistry;
import com.enliple.keyboard.imgmodule.util.pool.FactoryPools;
...
/**
 * Manages component registration to extend or replace ImageModule default loading, decoding, and
 * encoding logic.
 */
// Public API.
...
public class Registry {
   ...
   *     {@link com.enliple.keyboard.imgmodule.load.resource.gif.GifDrawable} etc).
   ...
   * which are identified as a unique string. ImageModule will attempt to decode using decoders in the
   ...
   * com.enliple.keyboard.imgmodule.load.resource.gif.GifDrawable} and any other subclass.
   *
  ...
  /**
   * Registers a new {@link com.enliple.keyboard.imgmodule.load.data.DataRewinder.Factory} to handle a
   ...
   * ModelLoaderFactory)}. This method is best for adding an additional case to ImageModule existing
   * functionality that should run first. This method will still run ImageModule default {@link
   ...
   * <p>If you're attempting to add additional functionality or add a backup that should run only
   * after the default {@link ModelLoader}s run, use {@link #append(Class, Class,
   * ModelLoaderFactory)}. This method should be used only when you want to ensure that ImageModule
   * default {@link ModelLoader}s do not run.
   *
   * <p>One good use case for this method is when you want to replace ImageModule default networking
   ...
   * allow ImageModule default networking library to run in some cases. Using this method will ensure
  ...
  /**
   * Thrown when no {@link com.enliple.keyboard.imgmodule.load.model.ModelLoader} is registered for a given
   * model class.
   */
