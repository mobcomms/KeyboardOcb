package com.enliple.keyboard.imgmodule.load.engine.bitmap_recycle;
...
/**
 * An {@link com.enliple.keyboard.imgmodule.load.engine.bitmap_recycle.BitmapPool} implementation that uses an
 * {@link com.enliple.keyboard.imgmodule.load.engine.bitmap_recycle.LruPoolStrategy} to bucket {@link Bitmap}s
    ...
    if (config == Bitmap.Config.HARDWARE) {
      throw new IllegalArgumentException(
          "Cannot create a mutable Bitmap with config: "
              ...
              + " RequestOptions and/or in ImageBuilder.setDefaultRequestOptions");
    }
  }
