...
import com.enliple.keyboard.imgmodule.gifdecoder.GifHeader;
import com.enliple.keyboard.imgmodule.gifdecoder.GifHeaderParser;
import com.enliple.keyboard.imgmodule.gifdecoder.StandardGifDecoder;
...
import com.enliple.keyboard.imgmodule.load.ImageHeaderParserUtils;
...
/**
 * An {@link com.enliple.keyboard.imgmodule.load.ResourceDecoder} that decodes {@link
 * com.enliple.keyboard.imgmodule.load.resource.gif.GifDrawable} from {@link java.io.InputStream} data.
 */
public class ByteBufferGifDecoder implements ResourceDecoder<ByteBuffer, GifDrawable> {
  ...
  public ByteBufferGifDecoder(Context context) {
    this(
        context,
        ImageModule.get(context).getRegistry().getImageHeaderParsers(),
        ImageModule.get(context).getBitmapPool(),
        ImageModule.get(context).getArrayPool());
  }
