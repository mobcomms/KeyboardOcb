...
import com.enliple.keyboard.imgmodule.load.resource.transcode.UnitTranscoder;
import com.enliple.keyboard.imgmodule.util.MultiClassKey;
import java.util.Collections;
import java.util.concurrent.atomic.AtomicReference;

/**
 * Maintains a cache of data, resource, and transcode classes to available {@link
 * com.enliple.keyboard.imgmodule.load.engine.LoadPath}s capable of decoding with the requested types.
 */
