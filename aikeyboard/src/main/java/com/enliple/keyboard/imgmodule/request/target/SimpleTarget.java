...
/**
 * A simple {@link com.enliple.keyboard.imgmodule.request.target.Target} base class with default (usually no-op)
 ...
 * ImageModule.with(fragment).clear(target);
 * </code>
 * </pre>
 *
 ...
 * load. ImageModule {@link RequestBuilder#into(Target)} method returns the {@link
 ...
 * application on older or memory constrained devices because it can cause ImageModule to load very large
 ...
 * Providing a valid size allows ImageModule to downsample large images, which can avoid issues with
