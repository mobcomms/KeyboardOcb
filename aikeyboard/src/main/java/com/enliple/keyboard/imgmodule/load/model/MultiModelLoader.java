 ...
 * com.enliple.keyboard.imgmodule.load.engine.DataFetcherGenerator} implementations and should try to avoid this
 * duplication.
 */
  ...
  static class MultiFetcher<Data> implements DataFetcher<Data>, DataCallback<Data> {
    ...
    private void startNextOrFail() {
      ...
      if (currentIndex < fetchers.size() - 1) {
        ...
        callback.onLoadFailed(new ImageModuleException("Fetch failed", new ArrayList<>(exceptions)));
      }
    }
  }
}
