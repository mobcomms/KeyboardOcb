...
import com.enliple.keyboard.imgmodule.ImageExperiments.Experiment;
...
import com.enliple.keyboard.imgmodule.load.engine.bitmap_recycle.BitmapPoolAdapter;
import com.enliple.keyboard.imgmodule.load.engine.bitmap_recycle.LruArrayPool;
import com.enliple.keyboard.imgmodule.load.engine.bitmap_recycle.LruBitmapPool;
import com.enliple.keyboard.imgmodule.load.engine.cache.DiskCache;
import com.enliple.keyboard.imgmodule.load.engine.cache.InternalCacheDiskCacheFactory;
import com.enliple.keyboard.imgmodule.load.engine.cache.LruResourceCache;
import com.enliple.keyboard.imgmodule.load.engine.cache.MemoryCache;
import com.enliple.keyboard.imgmodule.load.engine.cache.MemorySizeCalculator;
import com.enliple.keyboard.imgmodule.load.engine.executor.ImageExecutor;
import com.enliple.keyboard.imgmodule.manager.ConnectivityMonitorFactory;
import com.enliple.keyboard.imgmodule.manager.DefaultConnectivityMonitorFactory;
import com.enliple.keyboard.imgmodule.manager.RequestManagerRetriever;
import com.enliple.keyboard.imgmodule.manager.RequestManagerRetriever.RequestManagerFactory;
import com.enliple.keyboard.imgmodule.request.BaseRequestOptions;
...
/** A builder class for setting default structural classes for ImageModule to use. */
@SuppressWarnings("PMD.ImmutableField")
public final class ImageBuilder {
  private final Map<Class<?>, TransitionOptions<?, ?>> defaultTransitionOptions = new ArrayMap<>();
  private final ImageExperiments.Builder imageExperimentsBuilder = new ImageExperiments.Builder();
  private Engine engine;
  private BitmapPool bitmapPool;
  private ArrayPool arrayPool;
  private MemoryCache memoryCache;
  private ImageExecutor sourceExecutor;
  private ImageExecutor diskCacheExecutor;
  ...
  private ImageExecutor animationExecutor;
  private boolean isActiveResourceRetentionAllowed;
  @Nullable private List<RequestListener<Object>> defaultRequestListeners;

  /**
   * Sets the {@link com.enliple.keyboard.imgmodule.load.engine.bitmap_recycle.BitmapPool} implementation to use
  ...
  /**
   * Sets the {@link com.enliple.keyboard.imgmodule.load.engine.cache.MemoryCache} implementation to store
   * {@link com.enliple.keyboard.imgmodule.load.engine.Resource}s that are not currently in use.
   *
  ...
  /**
   * Sets the {@link com.enliple.keyboard.imgmodule.load.engine.cache.DiskCache.Factory} implementation to use
   * to construct the {@link com.enliple.keyboard.imgmodule.load.engine.cache.DiskCache} to use to store {@link
   * com.enliple.keyboard.imgmodule.load.engine.Resource} data on disk.
   *
  ...
  @SuppressWarnings("WeakerAccess")
  @NonNull
  public ImageBuilder setDiskCache(@Nullable DiskCache.Factory diskCacheFactory) {
    this.diskCacheFactory = diskCacheFactory;
    return this;
  }

  /**
   * Sets the {@link ImageExecutor} to use when retrieving {@link
   * com.enliple.keyboard.imgmodule.load.engine.Resource}s that are not already in the cache.
   *
   * <p>The thread count defaults to the number of cores available on the device, with a maximum of
   * 4.
   *
   * <p>Use the {@link ImageExecutor#newSourceExecutor()} methods if you'd like to specify options
   * for the source executor.
   *
   * @param service The ExecutorService to use.
   * @return This builder.
   * @see #setDiskCacheExecutor(ImageExecutor)
   * @see ImageExecutor
   * @deprecated Use {@link #setSourceExecutor(ImageExecutor)}
   */
  @Deprecated
  public ImageBuilder setResizeExecutor(@Nullable ImageExecutor service) {
  ...
  @SuppressWarnings("WeakerAccess")
  @NonNull
  public ImageBuilder setSourceExecutor(@Nullable ImageExecutor service) {
  ...
  /**
   * Sets the {@link ImageExecutor} to use when retrieving {@link
   * com.enliple.keyboard.imgmodule.load.engine.Resource}s that are currently in ImageModule disk caches.
   *
   ...
   *
   * <p>Use the {@link ImageExecutor#newDiskCacheExecutor()} if you'd like to specify options for
   * the disk cache executor.
   *
   * @param service The {@link ImageExecutor} to use.
   * @return This builder.
   * @see #setSourceExecutor(ImageExecutor)
   * @see ImageExecutor
   */
  // Public API.
  @SuppressWarnings("WeakerAccess")
  @NonNull
  public ImageBuilder setDiskCacheExecutor(@Nullable ImageExecutor service) {
    this.diskCacheExecutor = service;
    return this;
  }

  /**
   * Sets the {@link ImageExecutor} to use when loading frames of animated images and particularly
   * of {@link com.enliple.keyboard.imgmodule.load.resource.gif.GifDrawable}s.
   *
   * <p>Defaults to one or two threads, depending on the number of cores available.
   *
   * <p>Use the {@link ImageExecutor#newAnimationExecutor()} methods if you'd like to specify
  ...
  @SuppressWarnings("WeakerAccess")
  @NonNull
  public ImageBuilder setAnimationExecutor(@Nullable ImageExecutor service) {
   ...
   */
  @NonNull
  public ImageBuilder setDefaultRequestOptions(@Nullable final RequestOptions requestOptions) {
   ...
   * returns this {@code ImageModuleBuilder}.
   *
   ...
   */
  @NonNull
  public ImageBuilder setDefaultRequestOptions(@NonNull RequestOptionsFactory factory) {
   ...
   * {@link com.enliple.keyboard.imgmodule.load.resource.gif.GifDrawable} or {@link
  ...
  @NonNull
  public <T> ImageBuilder setDefaultTransitionOptions(
  ...
  @SuppressWarnings("WeakerAccess")
  @NonNull
  public ImageBuilder setMemorySizeCalculator(@Nullable MemorySizeCalculator calculator) {
    this.memorySizeCalculator = calculator;
    return this;
  }

  /**
   * Sets the {@link com.enliple.keyboard.imgmodule.manager.ConnectivityMonitorFactory} to use to notify {@link
   * RequestManager} of connectivity events. If not set {@link
   * com.enliple.keyboard.imgmodule.manager.DefaultConnectivityMonitorFactory} would be used.
   *
  ...
  @SuppressWarnings("unused")
  @NonNull
  public ImageBuilder setConnectivityMonitorFactory(@Nullable ConnectivityMonitorFactory factory) {
   ...
   *
   * <p>All logs will be logged using the 'ImageModule' tag.
   *
  ...
  @SuppressWarnings("unused")
  @NonNull
  public ImageBuilder setLogLevel(int logLevel) {
  ...
  /**
   * If set to {@code true}, allows ImageModule to re-capture resources that are loaded into {@link
   * com.enliple.keyboard.imgmodule.request.target.Target}s which are subsequently de-referenced and garbage
   * collected without being cleared.
   *
   * <p>Defaults to {@code false}.
   *
   * <p>ImageModule resource re-use system is permissive, which means that's acceptable for callers to
   * load resources into {@link com.enliple.keyboard.imgmodule.request.target.Target}s and then never clear the
   * {@link com.enliple.keyboard.imgmodule.request.target.Target}. To do so, ImageModule uses {@link
   * java.lang.ref.WeakReference}s to track resources that belong to {@link
   * com.enliple.keyboard.imgmodule.request.target.Target}s that haven't yet been cleared. Setting this method
   * to {@code true} allows ImageModule to also maintain a hard reference to the underlying resource so
   * that if the {@link com.enliple.keyboard.imgmodule.request.target.Target} is garbage collected, ImageModule can
   ...
   * resources into {@link com.enliple.keyboard.imgmodule.request.target.Target}s but never clear them.
   *
   * <p>If you set this method to {@code true} you <em>must not</em> call {@link Bitmap#recycle()}
   * or mutate any Bitmaps returned by ImageModule. If this method is set to {@code false}, recycling or
   * mutating Bitmaps is inefficient but safe as long as you do not clear the corresponding {@link
   * com.enliple.keyboard.imgmodule.request.target.Target} used to load the {@link Bitmap}. However, if you set
   * this method to {@code true} and recycle or mutate any returned {@link Bitmap}s or other mutable
   * resources, ImageModule may recover those resources and attempt to use them later on, resulting in
   ...
   * com.enliple.keyboard.imgmodule.request.target.Target}s when you're done with the corresponding resource.
   * Clearing {@link com.enliple.keyboard.imgmodule.request.target.Target}s allows ImageModule to maximize resource
  ...
  @SuppressWarnings("unused")
  @NonNull
  public ImageBuilder setIsActiveResourceRetentionAllowed(
  ...
  /**
   * Adds a global {@link RequestListener} that will be added to every request started with ImageModule.
   *
   ...
   * RequestListener#onLoadFailed(ImageModuleException, Object, Target, boolean)} or {@link
   ...
   *
   * <p>Because ImageModule requests can be started for any number of individual resource types, any
   ...
   */
  @NonNull
  public ImageBuilder addGlobalRequestListener(@NonNull RequestListener<Object> listener) {
  ...
  /**
   * Set to {@code true} to make ImageModule populate {@link
   * ImageModuleException#setOrigin(Exception)} for failed requests.
   *
   * <p>The exception set by this method is not printed by {@link ImageModuleException} and can only be
   * viewed via a {@link RequestListener} that reads the field via {@link
   * ImageModuleException#getOrigin()}.
   *
   * <p>This is an experimental API that may be removed in the future.
   */
  public ImageBuilder setLogRequestOrigins(boolean isEnabled) {
    imageExperimentsBuilder.update(new LogRequestOrigins(), isEnabled);
    return this;
  }

  /**
   * Set to {@code true} to make ImageModule use {@link android.graphics.ImageDecoder} when decoding
   ...
   * com.enliple.keyboard.imgmodule.load.resource.bitmap.Downsampler} and {@link android.graphics.BitmapFactory}
   ...
   * may still be used as part of {@link com.enliple.keyboard.imgmodule.load.Transformation}s because {@link
   * android.graphics.ImageDecoder} does not support Bitmap re-use.
   *
   * <p>When this flag is enabled {@link
   * com.enliple.keyboard.imgmodule.load.resource.bitmap.Downsampler#FIX_BITMAP_SIZE_TO_REQUESTED_DIMENSIONS} is
   * ignored. All other {@link com.enliple.keyboard.imgmodule.load.resource.bitmap.Downsampler} flags are
   ...
   * which may not agree.
   */
  public ImageBuilder setImageDecoderEnabledForBitmaps(boolean isEnabled) {
    imageExperimentsBuilder.update(
        new EnableImageDecoderForBitmaps(),
        /*isEnabled=*/ isEnabled && Build.VERSION.SDK_INT >= 29);
    return this;
  }
  ...
  // For testing.
  ImageBuilder setEngine(Engine engine) {
    this.engine = engine;
    return this;
  }

  @NonNull
  ImageModule build(@NonNull Context context) {
    if (sourceExecutor == null) {
      sourceExecutor = ImageExecutor.newSourceExecutor();
    }

    if (diskCacheExecutor == null) {
      diskCacheExecutor = ImageExecutor.newDiskCacheExecutor();
    }

    if (animationExecutor == null) {
      animationExecutor = ImageExecutor.newAnimationExecutor();
    }
    ...
    if (engine == null) {
      engine =
          new Engine(
              ...
              diskCacheExecutor,
              sourceExecutor,
              ImageExecutor.newUnlimitedSourceExecutor(),
              animationExecutor,
    ...
    ImageExperiments experiments = imageExperimentsBuilder.build();
