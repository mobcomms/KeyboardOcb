...
/**
 * Provides type independent options to customize loads with ImageModule.
 *
 * <p>Non-final to allow ImageModule generated classes to be assignable to their non-generated
 * equivalents.
 */
...
public class RequestOptions extends BaseRequestOptions<RequestOptions> {
  ...
  /**
   * Returns a {@link com.enliple.keyboard.imgmodule.request.RequestOptions} with {@link #encodeQuality(int)}
  ...
  /**
   * Returns a {@link com.enliple.keyboard.imgmodule.request.RequestOptions} with {@link
  ...
  /**
   * Returns a new {@link com.enliple.keyboard.imgmodule.request.RequestOptions} with {@link #dontAnimate()}
   * called.
   */
  @SuppressWarnings("WeakerAccess") // Public API
  @NonNull
