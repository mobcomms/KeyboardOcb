...
/**
 * A simple {@link com.enliple.keyboard.imgmodule.load.Transformation} for transforming {@link
 * android.graphics.Bitmap}s that abstracts away dealing with {@link
 * com.enliple.keyboard.imgmodule.load.engine.Resource} objects for subclasses.
 *
 ...
 *     private static final String ID = "com.enliple.keyboard.imgmodule.ImageModule.transformations.FillSpace";
...
public abstract class BitmapTransformation implements Transformation<Bitmap> {
  ...
  public final Resource<Bitmap> transform(
    ...
    BitmapPool bitmapPool = ImageModule.get(context).getBitmapPool();
   ...
   *
   * <p>The provided Bitmap, toTransform, should not be recycled or returned to the pool. ImageModule will
   ...
   * com.enliple.keyboard.imgmodule.request.target.Target#SIZE_ORIGINAL}, this class converts them to be the
   * size of the Bitmap we're going to transform before calling this method.
   *
   * @param pool A {@link com.enliple.keyboard.imgmodule.load.engine.bitmap_recycle.BitmapPool} that can be used
