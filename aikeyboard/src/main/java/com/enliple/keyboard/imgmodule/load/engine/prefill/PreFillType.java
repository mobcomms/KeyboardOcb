 ...
 * com.enliple.keyboard.imgmodule.load.engine.bitmap_recycle.BitmapPool} with {@link Bitmap Bitmaps} of a single
...
public final class PreFillType {
  ...
  public static class Builder {
     ...
     *
     * @param config The config to use, or null to use ImageModule default.
     * @return This builder.
     */
