...
public class ByteArrayLoader<Data> implements ModelLoader<byte[], Data> {
  ...
  private static class Fetcher<Data> implements DataFetcher<Data> {
     ...
     *     lead to OOMs. In practice it's unlikely that users would pass an array into ImageModule and
     *     then mutate it.
     */
  ...
  /**
   * Factory for {@link com.enliple.keyboard.imgmodule.load.model.ByteArrayLoader} and {@link
   * java.nio.ByteBuffer}.
   */
