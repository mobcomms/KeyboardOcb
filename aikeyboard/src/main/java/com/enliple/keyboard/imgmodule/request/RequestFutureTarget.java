...
/**
 * A {@link java.util.concurrent.Future} implementation for ImageModule that can be used to load resources
 ...
 * RequestManager requestManager = ImageModule.with(context);
 * try {
...
public class RequestFutureTarget<R> implements FutureTarget<R>, RequestListener<R> {
  ...
  @GuardedBy("this")
  @Nullable
  private ImageModuleException exception;
  ...
  public synchronized boolean onLoadFailed(
          @Nullable ImageModuleException e, Object model, Target<R> target, boolean isFirstResource) {
    loadFailed = true;
    exception = e;
    waiter.notifyAll(this);
    return false;
