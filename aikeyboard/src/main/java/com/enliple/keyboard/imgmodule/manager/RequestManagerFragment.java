 ...
 * RequestManager} that can be used to start, stop and manage ImageModule requests
 * started for targets the fragment or activity this fragment is a child of.
 *
 * @see com.enliple.keyboard.imgmodule.manager.SupportRequestManagerFragment
 * @see com.enliple.keyboard.imgmodule.manager.RequestManagerRetriever
 * @see RequestManager
 */
...
public class RequestManagerFragment extends Fragment {
  ...
  @NonNull
  ActivityFragmentLifecycle getImageLifecycle() {
    return lifecycle;
  }
  ...
  private void registerFragmentWithRoot(@NonNull Activity activity) {
    ...
    rootRequestManagerFragment =
        ImageModule.get(activity).getRequestManagerRetriever().getRequestManagerFragment(activity);
    if (!equals(rootRequestManagerFragment)) {
