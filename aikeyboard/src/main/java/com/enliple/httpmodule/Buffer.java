...
import static com.enliple.httpmodule.Util.checkOffsetAndCount;
import static com.enliple.httpmodule.Util.reverseBytesLong;
...
public final class Buffer implements BufferedSource, BufferedSink, Cloneable, ByteChannel {
   ...
   * its own invariants. Instead, it assumes a careful user who has studied MobonOkio's implementation
   ...
   * this is also the most efficient way to use buffers because it allows MobonOkio to employ several
   ...
   * </ul>
   *
   * <p>These optimizations all leverage the way MobonOkio stores data internally. MobonOkio Buffers are
   ...
   * saves the JVM from needing to zero-fill byte arrays. MobonOkio doesn't need to zero-fill its arrays
   ...
   * segment sizes will change with advances in hardware. Future versions of MobonOkio may even have
