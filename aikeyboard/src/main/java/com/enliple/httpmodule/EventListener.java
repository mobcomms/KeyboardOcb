 ...
 * <ul>
 *   <li>call -&gt; (dns -&gt; connect -&gt; secure connect)* -&gt; mobonRequest events</li>
 *   <li>call -&gt; (connection acquire/release)*</li>
 * </ul>
 *
 * <p>MobonRequest events are ordered:
 ...
 * scenarios. A redirect cross domain, or to use https may cause additional connection and mobonRequest
 * events.
 *
...
public abstract class EventListener {
   ...
   * limits, this call may be executed well before processing the mobonRequest is able to begin.
   *
  ...
  /**
   * Invoked just prior to sending mobonRequest headers.
   *
  ...
  /**
   * Invoked immediately after sending mobonRequest headers.
   *
   * <p>This method is always invoked after {@link #requestHeadersStart(Call)}.
   *
   * @param mobonRequest the mobonRequest sent over the network. It is an error to access the body of this
   *     mobonRequest.
   */
  public void requestHeadersEnd(Call call, MobonRequest mobonRequest) {
  }

  /**
   * Invoked just prior to sending a mobonRequest body.  Will only be invoked for mobonRequest allowing and
   * having a mobonRequest body to send.
   *
   * <p>The connection is implicit, and will generally relate to the last
   * {@link #connectionAcquired(Call, Connection)} event.
   *
  ...
  /**
   * Invoked immediately after sending a mobonRequest body.
   *
  ...
  /**
   * Invoked immediately after receiving mobonResponse headers.
   *
   * <p>This method is always invoked after {@link #responseHeadersStart}.
   *
   * @param mobonResponse the mobonResponse received over the network. It is an error to access the body of
   *     this mobonResponse.
   */
  public void responseHeadersEnd(Call call, MobonResponse mobonResponse) {
  }
  ...
  public interface Factory {
     ...
     * {@link MobonOkHttpClient#newCall(MobonRequest)}.
     *
