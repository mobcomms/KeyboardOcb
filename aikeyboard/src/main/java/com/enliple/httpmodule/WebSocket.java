 ...
 * create instances; usually this is {@link MobonOkHttpClient}.
 *
...
public interface WebSocket {
  /** Returns the original mobonRequest that initiated this web socket. */
  ...
  interface Factory {
     ...
     * no longer in use.
     */
    WebSocket newWebSocket(MobonRequest mobonRequest, WebSocketListener listener);
  }
}
