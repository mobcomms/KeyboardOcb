...
/**
 * The header fields of a single HTTP message. Values are uninterpreted strings; use {@code MobonRequest}
 * and {@code MobonResponse} for interpreted headers. This class maintains the order of the header fields
