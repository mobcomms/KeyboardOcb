...
public final class CacheControl {
  /**
   * Cache control mobonRequest directives that require network validation of responses. Note that such
   * requests may be assisted by the cache via conditional GET requests.
   */
  public static final CacheControl FORCE_NETWORK = new Builder().noCache().build();

  /**
   * Cache control mobonRequest directives that uses the cache only, even if the cached response is
   * stale. If the response isn't available in the cache or requires server validation, the call
   * will fail with a {@code 504 Unsatisfiable MobonRequest}.
   */
   ...
   *
   * <p>In a mobonRequest, it means do not use a cache to satisfy the mobonRequest.
   */
   ...
   * It is set by a client who only wants to make a mobonRequest if it can be fully satisfied by the
  ...
  /** Builds a {@code Cache-Control} mobonRequest header. */
  public static final class Builder {
     ...
     * maxAge}, it will not be used and a network mobonRequest will be made.
     *
     ...
     * used and a network mobonRequest will be made.
     *
     ...
     * Unsatisfiable MobonRequest} response will be returned.
     */
