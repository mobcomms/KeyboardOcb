 ...
 */
package com.enliple.httpmodule.internal.platform;
...
import com.enliple.httpmodule.internal.tls.BasicCertificateChainCleaner;
import com.enliple.httpmodule.internal.tls.BasicTrustRootIndex;
import com.enliple.httpmodule.internal.tls.CertificateChainCleaner;
import com.enliple.httpmodule.internal.tls.TrustRootIndex;
...
public class Platform {
  ...
  private static final Logger logger = Logger.getLogger(MobonOkHttpClient.class.getName());
  ...
  public void logCloseableLeak(String message, Object stackTrace) {
    if (stackTrace == null) {
      message += " To see where this was allocated, set the MobonOkHttpClient logger level to FINE: "
          + "Logger.getLogger(MobonOkHttpClient.class.getName()).setLevel(Level.FINE);";
    }
