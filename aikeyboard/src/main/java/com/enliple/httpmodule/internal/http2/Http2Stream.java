...
import com.enliple.httpmodule.AsyncTimeout;
...
public final class Http2Stream {
  ...
  /** MobonRequest headers. Immutable and non null. */
  private final List<Header> requestHeaders;

  /** MobonResponse headers yet to be {@linkplain #takeResponseHeaders taken}. */
