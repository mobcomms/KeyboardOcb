 ...
 */
package com.enliple.httpmodule.internal.cache2;
...
/**
 * Read and write a target file. Unlike MobonOkio's built-in {@linkplain MobonOkio#source(java.io.File) file
 * source} and {@linkplain MobonOkio#sink(java.io.File) file sink} this class offers:
 *
 * <ul>
