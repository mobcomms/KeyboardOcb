 ...
 * HTTP mobonRequest/response exchanges. Connections may be direct to the origin server or via a proxy.
 *
 ...
 * connection as a single mobonRequest/response exchange.
 *
 * <h3>Modern TLS</h3>
 *
